      ...
      <div className="max-w-[1800px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 pt-20 sm:pt-28 pb-16 sm:pb-20">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-16 lg:gap-8 items-start">
          ...
          <div className="flex flex-col items-center lg:items-start gap-6">
            <p className="text-[10px] font-bold uppercase tracking-[0.25em] text-brand-gold/60">
              {t('developer')}
            </p>
          ...
          <div className="flex flex-col items-center gap-5">
            ...
            <p className="font-mono text-xl sm:text-2xl text-white/90 tracking-[0.08em]" dir="ltr">
              {t('licenseNumber')}
            </p>
            {/* REGA Badge */}
          ...
          <div className="flex flex-col items-center lg:items-end gap-5">
            ...
            <a
              href="tel:920033262"
              className="font-mono text-xl sm:text-2xl text-brand-gold hover:text-white transition-colors duration-300 tracking-[0.08em]"
              dir="ltr"
            >
              {t('salesNumber')}
            </a>
            ...
            <div className="flex items-center gap-3 mt-1">
              ...
              <a
                ...
                className="w-11 h-11 border border-white/10 flex items-center justify-center text-white/60 hover:text-brand-gold hover:border-brand-gold/40 transition-all duration-300"
              >
        ...
        <div className="flex flex-col items-center gap-8">
          ...
          <div className="flex items-center gap-4">
            <a
              ...
              className="w-10 h-10 border border-white/8 flex items-center justify-center text-white/55 hover:text-white hover:border-white/25 transition-all duration-300"
            >
