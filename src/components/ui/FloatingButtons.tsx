    ...
    <div className="fixed bottom-6 end-4 sm:end-6 z-50 flex flex-col items-end gap-3">
      ...
      >
        ...
        <SpotlightButton spotlightColor="oklch(78% 0.12 75 / 0.30)" spotlightSize={80}>
          <div className="w-12 h-12 sm:w-14 sm:h-14 bg-brand-gold border border-brand-black/10 flex flex-col items-center justify-center text-brand-black hover:bg-brand-black hover:text-brand-gold transition-colors duration-300 shadow-[0_8px_32px_rgba(0,0,0,0.45)] active:scale-95">
            {/* Rotation icon */}
      ...
      >
        ...
        <SpotlightButton spotlightColor="oklch(85% 0.15 145 / 0.30)" spotlightSize={80}>
          <div className="w-12 h-12 sm:w-14 sm:h-14 bg-[#25D366] flex flex-col items-center justify-center shadow-[0_8px_32px_rgba(0,0,0,0.45)] hover:bg-[#1db954] transition-colors duration-300 active:scale-95">
