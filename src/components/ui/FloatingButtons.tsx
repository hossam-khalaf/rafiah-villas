    ...
    <div className="fixed bottom-6 end-4 sm:end-6 z-50 flex flex-col items-end gap-3">
      ...
      >
        ...
        <SpotlightButton spotlightColor="oklch(85% 0.15 145 / 0.30)" spotlightSize={80}>
          <div className="w-12 h-12 sm:w-14 sm:h-14 bg-brand-gold text-brand-black flex flex-col items-center justify-center shadow-[0_8px_32px_rgba(0,0,0,0.45)] hover:bg-brand-gold/80 transition-colors duration-300 active:scale-[0.98]">
            ...
            <span className="font-mono text-[8px] sm:text-[9px] font-bold tracking-tight leading-none mt-0.5 text-brand-black">CHAT</span>
          </div>
        </SpotlightButton>
      </a>
